    ...
    return (
        <>
            ...
            <button type="button" className="btn btn-outline-primary ms-auto" data-bs-toggle="modal" data-bs-target="#loginModal">
               <span className="fa fa-sign-in me-1"></span> Conecteaza-te
            </button>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Conecteaza-te</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-body">
                            <button className="btn btn-primary w-100 mb-4">
                               <span className="fa fa-google me-2"></span> Conecteaza-te cu Google
                            </button>
                            <button className="btn btn-primary w-100 mb-4">
                               <span className="fa fa-facebook me-2"></span> Conecteaza-te cu Facebook
                            </button>
                            <form>
                                <div className="mb-3">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="mb-3 form-check">
                                            ...
                                            <button type="submit" className="btn btn-outline-primary w-100 mt-5">Continua</button>
</form>
                                    </div>
                                </div>
                </div>
